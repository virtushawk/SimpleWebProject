...
class AccessMap {
    ...
    //todo изменить?
    static {
        COMMAND_MAP.put(AccountRole.GUEST,List.of(CommandType.HOME,CommandType.CATALOG,CommandType.PROFILE,CommandType.CREATURE,
                CommandType.LOGIN,CommandType.REGISTER,CommandType.CONFIRM_EMAIL,CommandType.SEARCH,CommandType.FORGOT_PASSWORD));
        COMMAND_MAP.put(AccountRole.INACTIVE,List.of(CommandType.HOME,CommandType.CATALOG,CommandType.CHANGE_AVATAR,
        ...
        COMMAND_MAP.put(AccountRole.BLOCKED,Arrays.asList(CommandType.HOME,CommandType.CATALOG,CommandType.CHANGE_AVATAR,
                CommandType.CONFIRM_EMAIL,CommandType.CREATURE,CommandType.LOGIN,CommandType.LOGOUT,CommandType.PROFILE,
                CommandType.REGISTER,CommandType.SEARCH,CommandType.FORGOT_PASSWORD));
        COMMAND_MAP.put(AccountRole.ADMIN,List.of(CommandType.HOME,CommandType.CONFIRM_EMAIL,CommandType.LOGIN,
        ...
        COMMAND_MAP.put(AccountRole.USER,List.of(CommandType.HOME,CommandType.CONFIRM_EMAIL,CommandType.LOGIN,
                CommandType.CATALOG,CommandType.CREATURE,CommandType.REGISTER,CommandType.EDIT_CREATURE,CommandType.PROFILE,
