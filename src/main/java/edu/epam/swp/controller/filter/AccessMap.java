...
class AccessMap {
    ...
    //todo изменить?
    static {
        commandMap.put(AccountRole.GUEST,List.of(CommandType.HOME,CommandType.CATALOG,CommandType.PROFILE,CommandType.CREATURE,
                CommandType.LOGIN,CommandType.REGISTER,CommandType.CONFIRM_EMAIL,CommandType.SEARCH,CommandType.FORGOT_PASSWORD));
        commandMap.put(AccountRole.INACTIVE,List.of(CommandType.HOME,CommandType.CATALOG,CommandType.CHANGE_AVATAR,
        ...
        commandMap.put(AccountRole.BLOCKED,Arrays.asList(CommandType.HOME,CommandType.CATALOG,CommandType.CHANGE_AVATAR,
                CommandType.CONFIRM_EMAIL,CommandType.CREATURE,CommandType.LOGIN,CommandType.LOGOUT,CommandType.PROFILE,
                CommandType.REGISTER,CommandType.SEARCH,CommandType.FORGOT_PASSWORD));
        commandMap.put(AccountRole.ADMIN,List.of(CommandType.HOME,CommandType.CONFIRM_EMAIL,CommandType.LOGIN,
        ...
        commandMap.put(AccountRole.USER,List.of(CommandType.HOME,CommandType.CONFIRM_EMAIL,CommandType.LOGIN,
                CommandType.CATALOG,CommandType.CREATURE,CommandType.REGISTER,CommandType.EDIT_CREATURE,CommandType.PROFILE,
