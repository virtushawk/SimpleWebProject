...
/**
 * CustomPasswordGenerator class is used to generate password for password recovery function.
 * @author romab
 */
public class CustomPasswordGenerator {
    ...
    private CustomPasswordGenerator() {}
    ...
    public static String generatePassword() {
        org.passay.PasswordGenerator generator = new PasswordGenerator();
