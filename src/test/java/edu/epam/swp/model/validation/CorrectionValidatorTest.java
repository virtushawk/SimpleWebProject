...
public class CorrectionValidatorTest {
    ...
    public void isNameTest(String name,boolean expected) {
        boolean actual = CorrectionValidator.isName(name);
        Assert.assertEquals(actual,expected);
    }

    @Test(dataProvider = "descriptionValidationData")
    public void isTextTest(String description,boolean expected) {
        boolean actual = CorrectionValidator.isText(description);
        Assert.assertEquals(actual,expected);
    }
